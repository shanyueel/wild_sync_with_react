  ...
  return(
    <div className={className}>
      <div className="l-activity-discussion__header">
        <label htmlFor="activity-discussion"><ReturnIcon className="o-activity-discussion__return-icon"/></label>
      ...
      <div className="l-activity-discussion__chatroom">
...
const StyledActivityPageDiscussionListArea = styled(ActivityPageDiscussionListArea)`
  width: 100%;
  height: 100%;
  display: flex;
