...
const Navbar = ({ className }) => {
  ...
  const [isActivityCreateModalOpen, setIsActivityCreateModalOpen] =
    useState(false);
  const [isAccountUpdateModalOpen, setIsAccountUpdateModalOpen] =
    useState(false);
        ...
        <div className="c-navbar__icons">
          <div className="o-navbar__icon">
            <input
              name="navbar-icons"
              type="checkbox"
              id="o-navbar__search-icon"
              ref={(element) => (navIconsRef.current[0] = element)}
              onChange={handleNavbarIconChange}
            />
            <label htmlFor="o-navbar__search-icon">
              <SearchIcon />
            </label>
          </div>
          <div className="o-navbar__icon">
            <input
              name="navbar-icons"
              type="checkbox"
              id="o-navbar__list-icon"
              ref={(element) => (navIconsRef.current[1] = element)}
              onChange={handleNavbarIconChange}
            />
            <label htmlFor="o-navbar__list-icon">
              <ListIcon />
            </label>
          </div>
          <div className="o-navbar__icon">
          ...
          {user.loggedIn && (
            <div className="o-navbar__icon">
              <label>
                <PlusIcon onClick={handleActivityCreateClick} />
              </label>
            </div>
          )}
          ...
          <div className="o-navbar__icon">
            <input
              ...
              type="checkbox"
              id="user-icon"
              ref={(element) => (navIconsRef.current[3] = element)}
              onChange={handleNavbarIconChange}
            />
            <label htmlFor="user-icon">
              <img src={user?.photoURL || userDefaultImage} alt="user-icon" />
            </label>
            <div className="l-navbar__user-dropdown">
              {user.uid ? (
                ...
                >
                  <img
                    className="o-navbar__user-avatar"
                    src={user?.photoURL}
                    alt="user-avatar"
                  />
                </Link>
                ...
                <img
                  className="o-navbar__user-avatar not-user"
              ...
              <ul className="l-navbar__user-dropdown-body">
                {user.loggedIn ? (
                  <>
                    <li
                      className="c-navbar__account-setting"
              ...
              <StyledActivityCreateModal
                isActivityCreateModalOpen={isActivityCreateModalOpen}
                setIsActivityCreateModalOpen={setIsActivityCreateModalOpen}
              />
              <StyledAccountUpdateModal
                isAccountUpdateModalOpen={isAccountUpdateModalOpen}
                setIsAccountUpdateModalOpen={setIsAccountUpdateModalOpen}
              />
            </div>
          </div>
        </div>
  ...
  @media screen and (min-width: 768px) {
    .l-navbar {
      ...
      .o-navbar__searchbar {
        ...
        &:has(input:focus) {
          box-shadow: 0 0 0 0.5px ${({ theme }) => theme.color.default};
        }
