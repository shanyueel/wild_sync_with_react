...
const AccountUpdateModal = ({className, isAccountUpdateModalOpen, setIsAccountUpdateModalOpen}) => {
      ...
      <div className='l-modal__body'>
        ...
        <div className='c-account-setting__summit'>
          ...
          <StyledButton 
            ...
            disabled={accountContent?.newPassword?.length > 0 && accountContent?.newPasswordCheck !== accountContent?.newPassword}
          >
            更新帳戶
          </StyledButton>
